 ...
 */
@Component
public class KmAuthHttpApiClient extends AuthHttpApiClient {
  ...
  public void init() {
    ...
    if (StringUtils.isBlank(url)) {
      throw new AuthUrlNotFoundException("Verify the YAML configuration file. No configuration "
          + "found to the key key_manager_auth.host");
    }
  ...
  private void buildHttpClient(String basePath) {
    ...
    KmAuthConnectivityApiClientDecorator connectivityApiClient =
        new KmAuthConnectivityApiClientDecorator(jsonClient);
