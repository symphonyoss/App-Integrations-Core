...
/**
 * Unit test for {@link PodAuthHttpApiClient}
 * Created by rsanchez on 23/02/17.
 */
@RunWith(MockitoJUnitRunner.class)
public class PodAuthHttpApiClientTest {
  ...
  public void testInitFail() {
    ...
    assertNull(podAuthHttpApiClient.getClient());
  }
  ...
  public void testInit() {
    ...
    podAuthHttpApiClient.init();
    assertNotNull(podAuthHttpApiClient.getClient());
  }
}
