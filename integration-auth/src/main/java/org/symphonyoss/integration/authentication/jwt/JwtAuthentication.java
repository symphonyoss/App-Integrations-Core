...
public class JwtAuthentication {
  ...
  // TODO Check with Robson if we can depend on integration-pod-api-client
  @Autowired
   ...
   */
  public String getSymphonyToken(String configurationId, String applicationToken) {
    Integration integration = integrationBridge.getIntegrationById(configurationId);
    String sessionToken = authenticationProxy.getSessionToken(integration.getSettings().getType());
    try {
      AppToken bothTokens = apiClient.getAppAuthenticationToken(sessionToken, configurationId, applicationToken);
      return bothTokens.getSymphonyToken();
    } catch (RemoteApiException e) {
