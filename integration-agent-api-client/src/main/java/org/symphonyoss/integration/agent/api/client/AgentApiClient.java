...
import org.symphonyoss.integration.agent.api.exception.AgentUrlNotFoundException;
import org.symphonyoss.integration.api.client.AuthenticationProxyApiClient;
import org.symphonyoss.integration.api.client.HttpApiClient;
import org.symphonyoss.integration.api.client.JsonHttpApiClient;
 ...
 */
@Component
public class AgentApiClient implements HttpApiClient {
  ...
  private void buildHttpClient(String basePath) {
    ...
    AgentConnectivityApiClientDecorator connectivityApiClient =
        new AgentConnectivityApiClientDecorator(jsonClient);
