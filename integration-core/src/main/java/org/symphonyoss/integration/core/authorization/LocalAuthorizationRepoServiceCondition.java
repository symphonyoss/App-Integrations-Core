...
/**
 * Conditional class to create a local implementation of {@link AuthorizationRepositoryService}
 * Created by rsanchez on 14/08/17.
 */
public class LocalAuthorizationRepoServiceCondition implements Condition {
