...
public class PodApiClientDecorator extends ApiClient {
  ...
  public PodApiClientDecorator() {
    ...
    try {
      this.defaultHeaderMap = getHeaderField();
   ...
   */
  @SuppressWarnings("unchecked")
  private Map<String, String> getHeaderField() throws NoSuchFieldException, IllegalAccessException {
  ...
  public void init() {
    ...
    if (StringUtils.isBlank(url)) {
      throw new IntegrationProvisioningAuthException(
  ...
  public <T> T invokeAPI(String path, String method, List<Pair> queryParams, Object body,
    ...
    Response response = invoke(method, body, contentType, invocationBuilder, formEntity);
    ...
    try {
      ...
      try {
        AuthenticationToken
            token = authenticationProxy.reAuthSessionOrThrow(sessionToken, e.getCode(), e);
