package org.symphonyoss.integration.pod.api.properties;

import org.symphonyoss.integration.pod.api.client.BaseIntegrationInstanceApiClient;

/**
 * {@link BaseIntegrationInstanceApiClient}
 * Created by alexandre-silva-daitan on 04/07/17.
 */
public class BaseIntegrationInstanceApiClientProperties {
  public static final String INSTANCE_EMPTY = "integration.pod.base.integration.instance.api.client.instance.empty";
