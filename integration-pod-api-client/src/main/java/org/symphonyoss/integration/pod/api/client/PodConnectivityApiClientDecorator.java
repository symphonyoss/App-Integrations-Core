...
/**
 * Decoratar class to deal with connectivity issues.
 * Created by rsanchez on 21/02/17.
 */
public class PodConnectivityApiClientDecorator extends ConnectivityApiClientDecorator {

  public PodConnectivityApiClientDecorator(HttpApiClient apiClient) {
    super(apiClient);
  }

  @Override
  protected ConnectivityException getConnectivityException(ProcessingException e) {
    return new PodConnectivityException(e);
  }
